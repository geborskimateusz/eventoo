...
// import { BookingActionTypes, AddAllTickets, SaveOrUpdateTicket } from '../store/booking.actions';
...
//       console.log(this.ticket)
//       this.store.dispatch(new SaveOrUpdateTicket({ orderedTicket: this.ticket }))
