...
public class PdfExperiment {
    ...
    public static void main(String[] args) throws IOException, DocumentException, URISyntaxException {
        ...
        generateOrder(document);

        document.close();

    }

    private static void generateOrder(Document document) throws DocumentException {
    ...
    private static Integer calculateTotal() {
        ...
        return generateOrdererdEvents().stream()
                .map(orderedTicketDTO -> orderedTicketDTO.getAmmount() * orderedTicketDTO.getTicket().getPrice())
